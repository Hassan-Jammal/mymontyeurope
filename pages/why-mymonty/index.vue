            ...
            <div class="container flex flex-col gap-4">
                ...
                <div class="grid lg:grid-cols-2 gap-4">
                    <div class="p-8 lg:p-12 bg-[#F7F7F7] rounded-[30px]">
                        ...
                        <NuxtImg loading="lazy" class="w-full mt-8" src="/images/no-surprise-fees.webp" :alt="t(`Pages.Why MyMonty.Section 2.Cards[2].Image Alt`)" width="924" height="928" />
                    </div>
                    <div class="p-8 lg:p-12 bg-[#F7F7F7] rounded-[30px]">
                        <div class="flex flex-col justify-center max-lg:items-center gap-4 lg:gap-8 max-lg:mx-auto max-lg:text-center">
                        ...
                        <NuxtImg loading="lazy" class="w-full mt-8" src="/images/here-for-you.webp" :alt="t(`Pages.Why MyMonty.Section 2.Cards[3].Image Alt`)" width="924" height="928" />
                    </div>
                </div>
                <div class="p-8 lg:p-12 bg-[#F7F7F7] rounded-[30px]">
                    <div class="flex flex-col justify-center items-center gap-4 lg:gap-8 lg:w-2/3 mx-auto text-center">
